...
[![License](https://img.shields.io/badge/License-Non--Commercial%20v1.0-red)](./LICENSE.txt)
...
# ➤ LimiX-2 Model Architecture and Pretraining Data

<div align="center">
  <img src="./doc/figures/fig2_architecture.png" alt="Figure 2: Overall structure of LimiX-2" width="68%">
  <br>
  <sub>Overall structure of LimiX-2. </sub>
</div>

<div align="center">
  <img src="./doc/figures/fig3_data_generation.png" alt="Figure 3: Synthetic data generation pipeline for pretraining" width="64%">
  <br>
...
- Balance Comprehensive Challenging Omni-domain Classification Benchmark: [bcco_cls](https://huggingface.co/datasets/stable-ai/bcco_cls)
- Balance Comprehensive Challenging Omni-domain Regression Benchmark: [bcco_reg](https://huggingface.co/datasets/stable-ai/bcco_reg)

# ➤ License

The code in this repository is licensed under the [Stable AI Technology Co., Ltd. License, Version 1.0 (September 2026)](./LICENSE.txt), which is **derived from the Apache License, Version 2.0**: Sections 1–9 reproduce the terms and conditions of Apache 2.0, with the definition of "License" in Section 1 modified solely to incorporate the additional provisions of Section 10 (**Additional Attribution and Model Naming Requirements**). Key points:

- When You distribute or make available the Work, any Derivative Work, or any product or service (including another AI model) that incorporates a material portion of the Work or its model weights, You must (a) provide a copy of this License or a reasonably accessible link to it, and (b) prominently display **"Built with StableAI LimiX"** in a reasonably visible location appropriate to the medium (e.g. related website, user interface, blog post, about page or product documentation).
- If You use the Work or its model weights to create, train, fine-tune, distill or otherwise improve an AI model that is subsequently distributed or made available to a third party, You must include **"LimiX"** at the beginning of that model's name.
- Internal research, evaluation, benchmarking or testing that is not distributed or made available to a third party does not constitute distribution or making available, and does not trigger the attribution or model-naming requirements.
- For the avoidance of doubt, model weights expressly distributed by the Licensor under this License are deemed part of the "Work" to the extent that any licensable intellectual property rights subsist in them.

Third-party code is subject to its own licenses and attribution requirements; see [LICENSE.txt](./LICENSE.txt).

Model weights are licensed separately.

- LimiX-2: [license](https://huggingface.co/stable-ai/LimiX-2/blob/main/LICENSE)
- LimiX-2M: [license](https://huggingface.co/stable-ai/LimiX-2M/blob/main/LICENSE.txt)
- LimiX-16M: [license](https://huggingface.co/stable-ai/LimiX-16M/blob/main/LICENSE.txt)
- LimiX-1_2M: [license](https://huggingface.co/stable-ai/LimiX-1_2M/blob/main/LICENSE)
- LimiX-1_16M: [license](https://huggingface.co/stable-ai/LimiX-1_16M/blob/main/LICENSE)
